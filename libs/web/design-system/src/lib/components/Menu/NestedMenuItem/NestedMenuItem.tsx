...
import { ListItemText } from '../../../core/List/List'
import { Menu, MenuProps } from '../../../core/Menu/Menu'
 ...
 */
export const NestedMenuItem = forwardRef<HTMLLIElement | null, NestedMenuItemProps>(
  function NestedMenuItem(props, ref) {
    ...
    const isSubmenuFocused = () => {
      ...
      const children = (menuContainerRef.current?.children ?? []) as Element[]
    ...
    return (
      ...
      >
        <MenuItem
          ...
          ref={menuItemRef}
          sx={{
            backgroundColor: open ? 'state.surface.hovered' : TRANSPARENT,
            paddingY: 1.75,
            paddingX: 2,
          }}
          onClick={e => {
        ...
        >
          <ListItemText disableTypography sx={{ color: 'inherit' }}>
            {label}
          </ListItemText>
          {rightIcon}
        </MenuItem>
